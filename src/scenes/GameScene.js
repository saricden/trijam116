...
class GameScene extends Scene {
  ...
  create() {
    ...
    this.light1 = this.lights.addLight(pMath.Between(0, this.tilemap.widthInPixels), pMath.Between(0, this.tilemap.heightInPixels), 300).setIntensity(3);
    this.light1.dirX = 1;
    this.light1.dirY = 1;

    this.light2 = this.lights.addLight(pMath.Between(0, this.tilemap.widthInPixels), pMath.Between(0, this.tilemap.heightInPixels), 300).setIntensity(3);
    this.light2.dirX = 1;

    this.light3 = this.lights.addLight(pMath.Between(0, this.tilemap.widthInPixels), pMath.Between(0, this.tilemap.heightInPixels), 300).setIntensity(3);
    this.light3.dirY = 1;
    ...
    this.gfx.lineStyle(4, 0xFF33CC, 0.25);
  ...
  update() {
    ...
    // Light "collision"
    const light1Circle = new Geom.Circle(this.light1.x, this.light1.y, 100);
    const light2Circle = new Geom.Circle(this.light2.x, this.light2.y, 100);
    const light3Circle = new Geom.Circle(this.light3.x, this.light3.y, 100);
